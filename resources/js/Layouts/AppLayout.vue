...
<!--                                Dashboard-->
<!--                            </jet-nav-link>-->
<!--                            <jet-nav-link :href="route('fridge')" :active="route().current('fridge')">-->
<!--                                Холодильник-->
<!--                            </jet-nav-link>-->
                                ...
                                <div class="ml-3 relative">
                                    <jet-dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            ...
                                            <jet-dropdown-link :href="route('products.scan')">
                                                Сканировать QR код
                                            </jet-dropdown-link>
                                        </template>
                                    </jet-dropdown>
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <div class="ml-3 relative">
                                    <jet-dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            <jet-dropdown-link :href="route('my.recipes')">
                                                Доступные рецепты
                                            </jet-dropdown-link>
                                            <div class="border-t border-gray-100"></div>
                                            <jet-dropdown-link :href="route('recipes.index')">
                                               Все рецепты
                                            </jet-dropdown-link>
                                        </template>
                                    </jet-dropdown>
...
<!--                    </jet-nav-link>-->
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="mt-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('types.index')" :active="route().current('products.index')">
                            Добавить продукты
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link :href="route('products.scan')" :active="route().current('products.scan')">
                            Сканировать QR код
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link :href="route('my.recipes')" :active="route().current('my.recipes')">
                            Доступные рецепты
                        </jet-responsive-nav-link>
